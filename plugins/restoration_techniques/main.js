						...
						if (entry.type == "group") {		
							...
							if ( entry.control == "checkbox" ) {
								...
								array.forEach(entry.options, lang.hitch(this,function(option, i){
									...
									nslidernodeheader = domConstruct.create("div", {
										style:"display:inline;", 
										innerHTML: "<span style='color:#000;' id='" + this.sliderpane.id + "_lvoption_" + groupid + "_" + i + "'> " + option.text + "</span>"
									});									
									ncontrolsnode.appendChild(nslidernodeheader);
									infoPic1 = domConstruct.create("a", {
										style: "color:black;margin-left:3px",
										href: "#",
										title: "Click for more information",
										innerHTML: "<img src='data:image/png;base64,'>"
									})
									nslidernodeheader.appendChild(infoPic1);
									on(infoPic1, "click", lang.hitch(this,function(e){
										domStyle.set(this.infoarea.domNode, 'display', '');
									...
									br = domConstruct.create("br",{});
									if (rlen == i){
										nslidernodeheader.appendChild(br);
									}
									nslidernodeheader.appendChild(br);
									parser.parse()	
								})); 
